...
\- `evidence/logs/01.04-git-remote.txt`
...
evidence/logs/01.01-java-version.txt

evidence/logs/01.02-maven-version.txt

evidence/logs/01.03-os-baseline.txt

evidence/logs/01.08-app-startup-8081.log
...
evidence/logs/01.09-endpoint-home-8081.txt

evidence/logs/01.10-endpoint-owners-find-8081.txt

evidence/logs/01.11-endpoint-vets-8081.txt
...
evidence/logs/01.14-manual-dependency-scan.txt
...
[docs/01.02-current-state-architecture.md](01.02-current-state-architecture.md)

Evidence Index

Evidence	Purpose

evidence/logs/01.01-java-version.txt	Java runtime baseline

evidence/logs/01.02-maven-version.txt	Build tool baseline

evidence/logs/01.03-os-baseline.txt	Host OS baseline

evidence/logs/01.08-app-startup-8081.log	Application startup evidence

evidence/logs/01.09-endpoint-home-8081.txt	Home endpoint validation

evidence/logs/01.10-endpoint-owners-find-8081.txt	Owners endpoint validation

evidence/logs/01.11-endpoint-vets-8081.txt	Vets endpoint validation

evidence/logs/01.14-manual-dependency-scan.txt	Initial dependency scan

evidence/screenshots/	Browser-based endpoint evidence

inventory/01.01-current-state-inventory.md	Current-state inventory table

docs/01.02-current-state-architecture.md	Current-state architecture diagram and description
