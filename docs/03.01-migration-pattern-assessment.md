...
Detailed sequencing is maintained in [`inventory/wave_plan.csv`](../inventory/wave_plan.csv) and [`docs/03.03-migration-wave-plan.md`](03.03-migration-wave-plan.md).
...
| Provide assumption and risk register | Complete | [`docs/03.04-assumptions-risk-register.md`](03.04-assumptions-risk-register.md), [`inventory/assumption_risk_register.csv`](../inventory/assumption_risk_register.csv) |
