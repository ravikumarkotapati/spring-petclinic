...
| Evidence | `inventory/02.01-app-inventory.json`, `inventory/02.04-database-inventory.csv`, `inventory/09.01-ingress-inventory.csv`, `inventory/02.03-egress-inventory.csv`, `inventory/03.01-migration-decision-matrix.csv` |
...
| Evidence | `docs/03.01-migration-pattern-assessment.md`, `inventory/03.01-migration-decision-matrix.csv` |
...
| Evidence | `inventory/02.04-database-inventory.csv`, `docs/02.01-discovery-findings-summary.md` |
...
| Evidence | `inventory/09.01-ingress-inventory.csv`, `inventory/02.03-egress-inventory.csv`, `docs/03.04-assumptions-risk-register.md` |
...
| Evidence | `inventory/03.01-migration-decision-matrix.csv`, `docs/03.01-migration-pattern-assessment.md` |
...
| Evidence | `docs/09.01-ingress-egress-network-design.md`, `inventory/09.01-ingress-inventory.csv`, `inventory/02.03-egress-inventory.csv`, `inventory/09.02-network-egress-allowlist.csv`, `docs/09.03-dns-tls-cutover-plan.md` |
...
| Evidence | `docs/10.02-adr-app-configuration-modernization.md`, `docs/10.01-rearchitect-app-configuration-summary.md`, `docs/10.04-reengineered-config-architecture.md`, `inventory/10.01-module10-dependency-delta.json` |
