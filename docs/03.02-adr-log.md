...
| Evidence | `docs/03.01-migration-pattern-assessment.md`, `inventory/migration_decision_matrix.csv` |
...
| Evidence | `inventory/database_inventory.csv`, `docs/02.01-discovery-findings-summary.md` |
...
| Evidence | `inventory/ingress_inventory.csv`, `inventory/egress_inventory.csv`, `docs/03.04-assumptions-risk-register.md` |
...
| Evidence | `inventory/migration_decision_matrix.csv`, `docs/03.01-migration-pattern-assessment.md` |
...
| Evidence | `docs/09.01-ingress-egress-network-design.md`, `inventory/ingress_inventory.csv`, `inventory/egress_inventory.csv`, `inventory/network_egress_allowlist.csv`, `docs/09.03-dns-tls-cutover-plan.md` |
...
| Evidence | `docs/10.02-adr-app-configuration-modernization.md`, `docs/10.01-rearchitect-app-configuration-summary.md`, `docs/10.04-reengineered-config-architecture.md`, `inventory/module10_dependency_delta.json` |
