...
| MG-04 Network and security hardening | Ingress, DNS, TLS, SMTP-like egress, unknown inbound, secrets | `inventory/ingress_inventory.csv`, `inventory/egress_inventory.csv`, `docs/03.04-assumptions-risk-register.md` | Network/security owner |
