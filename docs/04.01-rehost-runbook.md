...
| [`docs/04.02-rehost-ingress-design.md`](04.02-rehost-ingress-design.md) | Ingress and network design |
| [`docs/04.02-rehost-ingress-design.mmd`](04.02-rehost-ingress-design.mmd) | Mermaid ingress diagram |
| [`tests/smoke_test_rehost.ps1`](../tests/smoke_test_rehost.ps1) | Smoke test runner for Azure endpoint |
| `evidence/logs/04.02-rehost-deployment-summary.md` | Created after deployment; sanitized deployment summary |
| `evidence/logs/04.01-rehost-deployment-outputs.json` | Created after deployment; Terraform outputs without secret values |
| `evidence/logs/04.03-rehost-smoke-test-evidence.md` | Created after smoke test; endpoint results |
| `evidence/logs/04.04-rehost-smoke-test-results.csv` | Created after smoke test; machine-readable endpoint results |
...
$outputs = Get-Content evidence\logs\04.01-rehost-deployment-outputs.json | ConvertFrom-Json
...
|---|---|---|
| Design Azure VM landing pattern: VNet, subnet, NSG, VM, managed disk, Key Vault, monitoring and backup | Complete | `infra/terraform/rehost-vm/*.tf`, `docs/04.02-rehost-ingress-design.md` |
...
| Provide smoke test evidence | Complete | `evidence/logs/04.03-rehost-smoke-test-evidence.md`, `evidence/logs/04.04-rehost-smoke-test-results.csv` |
...
|---|---|
| `evidence/logs/04.02-rehost-deployment-summary.md` | Run `scripts/deploy_rehost_vm.ps1` |
| `evidence/logs/04.01-rehost-deployment-outputs.json` | Run `scripts/deploy_rehost_vm.ps1` |
| `evidence/logs/04.03-rehost-smoke-test-evidence.md` | Run `tests/smoke_test_rehost.ps1` |
| `evidence/logs/04.04-rehost-smoke-test-results.csv` | Run `tests/smoke_test_rehost.ps1` |
