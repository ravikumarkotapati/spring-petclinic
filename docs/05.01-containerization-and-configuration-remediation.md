...
| [`inventory/05.01-runtime-environment-matrix.csv`](../inventory/05.01-runtime-environment-matrix.csv) | Machine-readable environment variable matrix |
| [`evidence/logs/05.01-container-build.log`](../evidence/logs/05.01-container-build.log) | Container build command output |
| [`evidence/logs/05.02-container-compose-config.log`](../evidence/logs/05.02-container-compose-config.log) | Docker Compose configuration validation output |
| [`evidence/logs/05.05-container-image-scan.log`](../evidence/logs/05.05-container-image-scan.log) | Docker Scout vulnerability scan output |
| [`evidence/logs/05.04-container-image-scan-plan.md`](../evidence/logs/05.04-container-image-scan-plan.md) | Scan result summary, promotion gate and remediation plan |
...
| Externalize DB URL, credentials, API endpoints, TLS settings and feature flags | Complete | [`inventory/05.01-runtime-environment-matrix.csv`](../inventory/05.01-runtime-environment-matrix.csv), `Configuration Remediation` section |
...
| Show image tagging, SBOM/scanning and promotion | Complete | `Image Tagging, SBOM, Scanning And Promotion` section, [`evidence/logs/05.05-container-image-scan.log`](../evidence/logs/05.05-container-image-scan.log), [`evidence/logs/05.04-container-image-scan-plan.md`](../evidence/logs/05.04-container-image-scan-plan.md) |
