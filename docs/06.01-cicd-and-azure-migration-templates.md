...
| Pipeline evidence and rollback strategy | Complete | [`evidence/logs/module6-pipeline-validation.log`](../evidence/logs/module6-pipeline-validation.log), [`docs/06.02-cicd-rollback-strategy.md`](06.02-cicd-rollback-strategy.md) |
