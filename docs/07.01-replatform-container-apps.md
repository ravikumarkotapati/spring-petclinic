...
Detailed comparison is captured in [`inventory/07.01-replatform-target-comparison.csv`](../inventory/07.01-replatform-target-comparison.csv).
...
| Target comparison table | Complete | [`inventory/07.01-replatform-target-comparison.csv`](../inventory/07.01-replatform-target-comparison.csv) |
