...
| PostgreSQL | `src/main/resources/application-postgres.properties`, `src/main/resources/db/postgres/`, `inventory/02.03-egress-inventory.csv` flow `F002` | Chosen production migration path |
| MySQL | `src/main/resources/application-mysql.properties`, `src/main/resources/db/mysql/`, `inventory/02.03-egress-inventory.csv` flow `F003` | Optional profile, not selected |
...
| Evidence | File |
|---|---|
| Database dependency inventory | `inventory/02.04-database-inventory.csv` |
| Schema conversion report | `scripts/schema_convert/conversion_report.md` |
| Data validation harness output | `evidence/logs/08.20-db-data-validation-results.md` |
| Migration runbook | `docs/08.03-db-migration-runbook.md` |
| Live Azure PostgreSQL deployment | `evidence/logs/08.05-db-azure-postgres-deployment-summary.md` |
| Live Azure validation queries | `evidence/logs/08.13-db-azure-validation-queries.txt` |
