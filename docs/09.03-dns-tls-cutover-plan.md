...
|---|---|---|
| App smoke test passes on managed endpoint | App owner | `evidence/logs/08.29-db-post-cutover-smoke-test-results.md` |
| Azure PostgreSQL target is ready | DB owner | `evidence/logs/08.05-db-azure-postgres-deployment-summary.md` |
...
4. If database cutover is implicated, follow `docs/08.03-db-migration-runbook.md` rollback steps.
...
| Evidence | File |
|---|---|
| Ingress inventory | `inventory/09.01-ingress-inventory.csv` |
