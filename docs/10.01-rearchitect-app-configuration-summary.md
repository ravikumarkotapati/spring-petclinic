...
| ADR | `docs/10.02-adr-app-configuration-modernization.md` |
| Updated diagram | `docs/10.04-reengineered-config-architecture.md` |
| Risk/benefit assessment | `docs/10.03-rearchitect-config-risk-benefit.md` |
| Validation evidence | `evidence/logs/10.04-validation.md` |
| Updated dependency crawler output | `inventory/10.01-module10-dependency-delta.json`, `inventory/02.01-app-inventory.csv`, `inventory/02.03-egress-inventory.csv`, `inventory/02.02-dependency-graph.mmd`, `inventory/09.02-network-egress-allowlist.csv` |
...
- `inventory/02.03-egress-inventory.csv`
- `inventory/09.02-network-egress-allowlist.csv`
- `inventory/02.02-dependency-graph.mmd`
- `inventory/10.01-module10-dependency-delta.json`
