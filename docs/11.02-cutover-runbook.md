...
| Rollback plan | `docs/11.03-rollback-plan.md` |
...
| Gate | Evidence |
|---|---|
| Target app revision healthy | `evidence/logs/07.07-container-app-health-evidence.md` |
| Database target selected and migrated | `docs/08.02-db-target-selection-adr.md`, `evidence/logs/08.05-db-azure-postgres-deployment-summary.md` |
| Data validation passed | `evidence/logs/08.20-db-data-validation-results.md`, `evidence/logs/08.13-db-azure-validation-queries.txt` |
| Connection strings externalized | `docs/08.04-db-connection-string-remediation.md` |
| DNS/TLS plan approved | `docs/09.03-dns-tls-cutover-plan.md` |
| Egress allowlist approved | `inventory/09.02-network-egress-allowlist.csv` |
| Runtime configuration pattern approved | `docs/10.01-rearchitect-app-configuration-summary.md` |
| Rollback owner assigned | `docs/11.03-rollback-plan.md` |
| Smoke test script ready | `tests/smoke_test.sh` |
| Hypercare bridge ready | `docs/11.04-hypercare-checklist.md` |
...
Follow `docs/11.03-rollback-plan.md` if any trigger is met:
...
| Evidence | Location |
|---|---|
| Smoke test output | `evidence/logs/11.02-smoke-test-results.csv` and `evidence/logs/11.01-smoke-test-evidence.md` |
| Cutover decision log | Change ticket or release notes |
| App revision state | `az containerapp revision list` output |
| Database validation | `evidence/logs/08.20-db-data-validation-results.md` |
| Hypercare updates | `docs/11.04-hypercare-checklist.md` |
