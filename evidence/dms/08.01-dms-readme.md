...
| Migration log | `../logs/08.25-db-migration-log.md` |
| Throughput and error evidence | `../logs/08.26-db-migration-throughput.csv` |
| Offline lag chart | `../logs/08.30-db-replication-lag.csv` |
