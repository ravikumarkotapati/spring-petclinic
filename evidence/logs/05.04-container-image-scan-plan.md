...
| Scan evidence | [`05.05-container-image-scan.log`](05.05-container-image-scan.log) |
| Remediation recommendation evidence | [`05.06-container-image-recommendations.log`](05.06-container-image-recommendations.log) |
| Image metadata evidence | [`05.03-container-image-inspect.json`](05.03-container-image-inspect.json) |
...
```powershell
docker sbom petclinic:<git-sha> --format cyclonedx-json > evidence/logs/05.07-container-sbom.json
```

or

```powershell
syft petclinic:<git-sha> -o cyclonedx-json > evidence/logs/05.07-container-sbom.json
```
